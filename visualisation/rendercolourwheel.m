...
[az, el] = view;
view(az + 180, el);
file = fullfile(renderPath, 'colourwheel3-rotated-600dpi.png');
export_fig(file, '-png', '-r600', '-transparent', F);
file = fullfile(renderPath, 'colourwheel3-rotated-1200dpi.png');
export_fig(file, '-png', '-r1200', '-transparent', F);
file = fullfile(renderPath, 'colourwheel3-rotated-600dpi.jpg');
export_fig(file, '-jpg', '-r600', '-q100', '-transparent', F);
file = fullfile(renderPath, 'colourwheel3-rotated-1200dpi.jpg');
export_fig(file, '-jpg', '-r1200', '-q100', '-transparent', F);
