...
view(3);
colorbar;
savefigure(gcf, fullfile('./', 'renderings', 'ofish', sprintf('rho-600dpi.png')), '-png', '-r600');
view(2);
savefigure(gcf, fullfile('./', 'renderings', 'ofish', sprintf('rho-top-600dpi.png')), '-png', '-r600');
...
daspect([1, 1, 1]);
view(3);
savefigure(gcf, fullfile('./', 'renderings', 'ofish', sprintf('surface-600dpi.png')), '-png', '-r600');
...
for k=1:2
    ...
    daspect([1, 1, 1]);
    view(3);
    savefigure(gcf, fullfile('./', 'renderings', 'ofish', sprintf('data-%i-600dpi.png', k)), '-png', '-r600');
...
daspect([1, 1, 1]);
view(3);
savefigure(gcf, fullfile('./', 'renderings', 'ofish', sprintf('ofish-600dpi.png')), '-png', '-r600');
view(2);
savefigure(gcf, fullfile('./', 'renderings', 'ofish', sprintf('ofish-top-600dpi.png')), '-png', '-r600');
